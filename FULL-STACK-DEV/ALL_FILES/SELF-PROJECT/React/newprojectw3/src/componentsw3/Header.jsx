    ...
    <div>
      <div className="headertop" id="top">
        <div className="headertop2">
          <BiLogoMailchimp size={50} color="darkgreen" className="logotop" />
          LOGO
        </div>
        <div className="headertop3">
          <p className="headerabout">
            <LoaderIcon size={29} duration={1.5} color="red" />{" "}
            <a href="#about"> ABOUT</a>
          </p>
          <p className="headerteam">
            <UsersIcon size={29} duration={1.5} color="red" />
            <a href="#team"> TEAM</a>
          </p>
          <p className="headerwork">
            <BlocksIcon size={29} duration={1.5} color="red" />
            <a href="#work"> WORK</a>
          </p>
          <p className="headerpricing">
            <DollarSignIcon size={29} duration={1.5} color="red" />{" "}
            <a href="#pricing"> PRICING</a>
          </p>
          <p className="headercontact">
            <PhoneCallIcon size={29} duration={1.5} color="red" />{" "}
      ...
      <div>
        <div className="headertextstyle">
          ...
          <p className="headertexttwo">
            Stop wasting valuable time with projects that just aren't you.
          </p>
